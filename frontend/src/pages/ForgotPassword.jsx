              ...
              <form className="flex flex-col gap-md mt-sm" onSubmit={handleSubmit}>
                <div className="flex flex-col gap-xs">
                  ...
                  <div className="relative">
                    ...
                    <input className="w-full pl-lg pr-sm py-sm rounded border border-outline-variant bg-surface-container-lowest text-on-surface font-body-md text-body-md transition-all focus:border-secondary focus:ring-1 focus:ring-secondary outline-none placeholder:text-outline-variant" id="email" placeholder="name@example.com" required type="email" value={email} onChange={e=>setEmail(e.target.value)}
                ...
                <div className="flex flex-col gap-sm mt-sm">
                  <button className="w-full bg-primary-container text-on-primary font-label-md text-label-md py-sm px-md rounded hover:bg-primary transition-colors flex items-center justify-center gap-base" type="submit" disabled={loading}>
